            ...
            <tr>
               	<td height="500" bgcolor="#F8F9FA" align="center">
               		<table border="0" cellspacing="0" cellpadding="10">
               			<form action="resultpw" method="post" name="reg_frm">
               				<tr><td><h5>비밀번호 찾기</h5><hr></td></tr>
               				<tr><td>&nbsp;</td></tr>
               				<tr>
               				<td>아이디&nbsp;&nbsp;</td>
               				...
               				<input id="button01" class="btn btn-warning" type="button" value="비밀번호 찾기" onclick="infoConfirm()">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
