...
<div class="right">
	...
	<table class="table">
	  ...
	  <c:forEach items="${list}" var = "dto">
	    <tr>
	      <th scope="row"  class="text-center"><a href="customerinfo?mid=${dto.mid}">${dto.mid}</a></th>
	      <td style="width: 40%" class="text-center">${dto.mname}</td>  
	      <td style="width: 10%" class="text-center">${dto.mphone}</td>
	      <td style="width: 20%" class="text-center">${dto.memail}</td>
	      <td style="width: 20%" class="text-center">${dto.mdate}</td>
	    </tr>  
	   </c:forEach>
	  </tbody>
	</table>
